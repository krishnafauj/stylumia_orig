...
function SubvsSubform() {
    ...
    const handleApply = () => {
        ...
        alert(`Category 1: ${selectedCategory1}, Category 2: ${selectedCategory2}, Duration: ${selectedDuration}, Date: ${selectedDate}`);
    };
